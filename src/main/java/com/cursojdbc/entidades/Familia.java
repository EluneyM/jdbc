...
public class Familia {
    ...
    public Familia(Integer idFamilia, String nombre, Integer edadMinima, Integer edadMaxima, Integer numHijos,
            String email, Integer idCasaFamilia) {
    ...
    public Familia(String nombre, Integer edadMinima, Integer edadMaxima, Integer numHijos, String email,
            Integer idCasaFamilia) {
        this.nombre = nombre;
        this.edadMinima = edadMinima;
        this.edadMaxima = edadMaxima;
        this.numHijos = numHijos;
